...
///      most protein into the small intestine (i.e. roughly during the meal's
///      peak emptying window).
///   2. Pressure amplitude scales with total protein grams (relative to a
///      moderate reference of ~20 g).
///   3. The competition score is the overlap of this pressure timeline with
///      the absorption opportunity window.
...
class AminoAcidCompetitionModel {
  ...
  CompetitionPressureTimeline build({
    ...
    for (var t = startMin; t <= endMin; t += sampleStrideMinutes) {
      ...
      // modifiers) modulated by protein amplitude.
