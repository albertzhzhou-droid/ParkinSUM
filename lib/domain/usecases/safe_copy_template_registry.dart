...
class SafeCopyTemplateRegistry {
  ...
  List<SafeCopyTemplate> get templates => const [
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'This educational prototype shows a modeled, source-linked '
            'overlap estimate of {overlap_percent}%. It is not medical '
            'advice and is not clinically calibrated.',
        'zh':
            '本教育原型展示一个建模的、可溯源的重叠估计（{overlap_percent}%）。'
            '这不是医疗建议，也未经临床校准。',
      },
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'The source coverage is incomplete, so this result is shown '
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'This is a local educational evidence trace. It is not a '
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'This prototype is not clinically calibrated and carries no '
    ...
    SafeCopyTemplate(
      ...
      notes:
          'Shared default safety-boundary text (consumed at runtime by '
    ...
    SafeCopyTemplate(
      ...
      requiresNotAdviceText: true,
      notes:
          'Onboarding safety-education title; mirrors i18n key '
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'No significant rule conflicts were detected (based only on '
            'built-in rules; not medical advice).',
      },
      requiredSafetyTerms: ['not medical advice'],
      requiresNotAdviceText: true,
      notes:
          'Legacy "no conflict" educational result; mirrors i18n key '
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'ParkinSUM gives conservative prompts from medication, meal, '
      ...
      notes:
          'Onboarding safety-education body; mirrors i18n key '
    ...
    SafeCopyTemplate(
      ...
      notes:
          'Onboarding account-scope title; mirrors i18n key '
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'After onboarding, profile, medications, intakes, and later '
            'audit records are saved under the current account user space.',
      },
      notes:
          'Onboarding account-scope body; mirrors i18n key '
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'Built-in rules checked this meal against {drugCount} '
      ...
      notes:
          'Legacy analysis framing; mirrors i18n key `legacy.analysis` '
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'Treat this as a lightweight screening result and confirm '
            'exact medication timing when you need more specific guidance.',
      },
      requiredSafetyTerms: ['screening result'],
      notes:
          'Legacy analysis follow-up disclaimer; mirrors i18n key '
    ...
    SafeCopyTemplate(
      ...
      requiredSafetyTerms: [],
      notes:
          'Legacy rule finding title; mirrors i18n key '
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'This meal contains about {protein} g of protein, which is '
      ...
      requiredSafetyTerms: [],
      notes:
          'Legacy rule finding detail; mirrors i18n key '
    ...
    SafeCopyTemplate(
      ...
      outputType: 'informational',
      defaultLocale: 'en',
      localizedText: {'en': 'Protein may affect medication absorption'},
      requiredSafetyTerms: [],
      notes:
          'Legacy rule finding title; mirrors i18n key '
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'This meal contains about {protein} g of protein and may '
    ...
    SafeCopyTemplate(
      ...
      outputType: 'informational',
      defaultLocale: 'en',
      localizedText: {'en': 'Possible high-tyramine food risk'},
      requiredSafetyTerms: [],
      notes:
          'Legacy rule finding title; mirrors i18n key '
          '`legacy.tyramine` (en).',
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'This meal includes foods marked as high tyramine. Combined '
    ...
    SafeCopyTemplate(
      ...
      outputType: 'informational',
      defaultLocale: 'en',
      localizedText: {'en': 'Meal timing note for mineral supplements'},
      requiredSafetyTerms: [],
      notes:
          'Legacy rule finding title; mirrors i18n key '
          '`legacy.mineral` (en).',
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'This meal includes dairy and may suggest higher calcium '
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'Overall score {score}/100 ({severity}), with {count} '
      ...
      requiredSafetyTerms: [],
      notes:
          'Legacy result summary line; mirrors i18n key '
          '`legacy.summary` (en).',
    ),
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'The current meal estimate contains about {protein} g of '
            'protein.',
      },
      ...
      requiredSafetyTerms: [],
      notes:
          'Legacy analysis protein segment; mirrors i18n key '
    ...
    SafeCopyTemplate(
      ...
      localizedText: {
        'en':
            'This meal also contains foods tagged as higher tyramine '
            'risk in the built-in catalog.',
      },
      requiredSafetyTerms: [],
      notes:
          'Legacy analysis tyramine segment; mirrors i18n key '
