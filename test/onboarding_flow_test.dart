...
void main() {
  test('normalizes content jurisdiction overrides', () {
    expect(OnboardingDraft.parseJurisdictionOverride(' us, ca,US, cn ,, '), [
      'US',
      'CA',
      'CN',
    ]);
  ...
  test(
    'builds profile from onboarding selections without dropping AI settings',
    () {
  ...
  test(
    'builds optional initial intake only when drug and time are present',
    () {
