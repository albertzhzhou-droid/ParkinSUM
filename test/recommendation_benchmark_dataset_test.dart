...
void main() {
  test(
    'default recommendation benchmark dataset covers key safety scenarios',
    () {
      ...
      expect(
        dataset.cases.any((item) => item.focusTags.contains('levodopa')),
        isTrue,
      );
      expect(
        dataset.cases.any(
      ...
      expect(
        dataset.cases.any((item) => item.focusTags.contains('missing_data')),
        isTrue,
      );
    },
  );
