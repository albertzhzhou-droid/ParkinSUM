...
void main() {
  ...
  LocalizationSafetyReport lintOne(
    LocalizationSurface surface, {
  ...
  test('4. surface with a banned advice phrase fails (blocker)', () {
    final r = lintOne(
      s('x', 'en', 'k', 'We suggest the recommended dose now.'),
    );
  ...
  test('8. English banned phrases detected', () {
    for (final p in [
      ...
      expect(
        hasType(r, LocalizationSafetyLint.bannedPhrase),
        isTrue,
  ...
  test('13. unknown placeholder is reported', () {
    final r = lintOne(
      s(
        ...
        'en',
        'k',
        'value {overlap_percent} and {rogue}',
        role: 'plain',
  ...
  test('14. missing required placeholder is reported', () {
    ...
    expect(
      hasType(r, LocalizationSafetyLint.missingRequiredPlaceholder),
      isTrue,
    );
  });
  ...
  test('18. existing safe registry passes with 0 blockers', () {
    ...
    expect(
      hasType(r, LocalizationSafetyLint.noLocaleDictionaryDiscovered),
      isTrue,
    );
  });
  ...
  test('21. arbitrary policy values are still scanned', () {
    final r = lintOne(
      s('x', 'en', 'k', 'adjust your dose', role: 'policy_value'),
    );
    expect(hasType(r, LocalizationSafetyLint.bannedPhrase), isTrue);
  });
}
