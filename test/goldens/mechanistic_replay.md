...
- result_availability: available
- has_modeled_output: true
- interaction_score: 0.476
- severity_band: high
- confidence_band: medium
- amino_acid_competition_band: high
...
- result_availability: available
- has_modeled_output: true
- interaction_score: 0.262
- severity_band: moderate
- confidence_band: low
- amino_acid_competition_band: moderate
...
## s06_missing_protein — Missing meal protein data → typed insufficient abstention
- pass: true
- result_availability: insufficient
- has_modeled_output: false
- interaction_score: null
- severity_band: null
- confidence_band: null
- amino_acid_competition_band: null
- gastric_emptying: no_profile
- banned_phrase_hits: 0

- abstention_reasons: meal_composition(comp_s06_missing_protein_meal_partial).protein_grams
...
- abstention_reasons: meal_events
...
- abstention_reasons: medication.invalid_context(med_s08_bare_numeric_0)
...
- abstention_reasons: medication.invalid_context(med_s09_levodopa_no_unit_0)
...
- abstention_reasons: medication.invalid_context(med_s10_slashed_no_unit_0)

## s11_mixed_solid_liquid — Mixed meal with liquid + solid components
- pass: true
- result_availability: available
- has_modeled_output: true
- interaction_score: 0.107
- severity_band: low
- confidence_band: high
- amino_acid_competition_band: low
...
- abstention_reasons: medication.invalid_context(med_s20_invalid_medication_no_window_scoring_0)

## s21_no_user_window_mechanistic_primary_unavailable — No recorded meal or user window → base engine abstains and candidate scoring reports the missing window
- pass: true
- result_availability: insufficient
- has_modeled_output: false
- interaction_score: null
...
- abstention_reasons: medication.invalid_context(med_s24_levodopa_no_unit_invalid_0)
...
- abstention_reasons: medication.invalid_context(med_s25_slashed_no_unit_invalid_0)

## s26_trace_only_preserves_legacy_order — Candidate window produces educational traces without treating a missing recorded meal as no interaction
- pass: true
- result_availability: insufficient
- has_modeled_output: false
- interaction_score: null
...
- abstention_reasons: medication.invalid_context(med_s29_bare_numeric_invalid_with_window_0)

## s30_no_window_fallback_visible — No recorded meal or user window with amino-acid candidate → base engine abstains and fallback reason stays visible
- pass: true
- result_availability: insufficient
- has_modeled_output: false
- interaction_score: null
...
## s36_missing_all_macros_unknown_competition — All macronutrients missing → typed insufficient abstention (never fabricated)
- pass: true
- result_availability: insufficient
- has_modeled_output: false
- interaction_score: null
...
- abstention_reasons: meal_composition(comp_s36_missing_all_macros_unknown_competition_meal_all_missing).composition_completeness, meal_composition(comp_s36_missing_all_macros_unknown_competition_meal_all_missing).protein_grams
...
## s40_spl_er_section_provenance — SPL-style ER carbidopa/levodopa stays outside the IR-only model context of use
- pass: true
- result_availability: insufficient
- has_modeled_output: false
- interaction_score: null
